...
function Navber() {
  ...
  return (
    <nav
      className={`fixed top-0 w-full z-50  border-spacing-0 transition-all duration-300 ${
        scrolled
    ...
    <button className="w-full group p-[4px] rounded-[12px] bg-[linear-gradient(180deg,#294C32_0%,#67DF89_100%)] shadow-[0_2px_4px_rgba(0,0,0,0.7)] hover:shadow-[0_4px_8px_rgba(0,0,0,0.6)] active:shadow-[0_0px_1px_rgba(0,0,0,0.8)] active:scale-[0.995] transition-all duration-200">
      ...
      {menuOpen && (
        ...
        >
          ...
          {/* <button className="bg-gradient-to-b from-green-900 to-green-400 text-white px-5 py-2 rounded-md shadow-md hover:shadow-green-500/50 transition">
            Contact us
          </button> */}
        </div>
      )}
