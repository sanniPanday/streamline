...
function AllProducts() {
  return (
    <section className="bg-gray-900 py-16 px-6 md:px-12">
      <div className="max-w-7xl mx-auto text-center mb-12">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">All Products</h2>
        <p className="text-white px-14 mx-auto  font-normal text-[18px] leading-[26px] tracking-[0%] text-center">
  ...
  <div className="bg-white shadow-md rounded-lg w-full sm:w-[90%] lg:w-[620px] h-[569px] flex flex-col items-center p-6">
    ...
    <div>
    <h3 className="text-xl font-semibold mb-2">Claim Route 360</h3>
...
<p className="text-gray-600 text-">
  ...
  <img src={btt} alt="Go to page" className="cursor-pointer" />
</Link>
    </div>
  ...
  <div className="bg-white shadow-md rounded-lg w-full sm:w-[90%] lg:w-[620px] h-[569px] flex flex-col items-center p-6">
    ...
    <div>
    <h3 className="text-xl font-semibold mb-2">Privicam</h3>
   <div className="flex align-center">
<p className="text-gray-600 text-">
      Built for industries who need to save time by keeping claims, scheduling, and routes simple and efficient.
    </p>
  ...
  <div className="bg-white shadow-md rounded-lg w-full sm:w-[90%] lg:w-[620px] h-[569px] flex flex-col items-center p-6">
    ...
    <div>
    <h3 className="text-xl font-semibold mb-2">Crypto Launchpad</h3>
   <div className="flex align-center">
<p className="text-gray-600 text-">
      Built for industries who need to save time by keeping claims, scheduling, and routes simple and efficient.
    </p>
