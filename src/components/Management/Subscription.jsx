    ...
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center px-4 py-10">
      <div className="mb-6">
        <div className="flex justify-center items-center w-[260px] h-[54px]  ">
          <button className="px-6 py-3 text-sm bg-orange-500 text-white rounded-l-lg">
            Monthly
          </button>
          <button className="px-6 py-3  text-sm bg-white text-gray-400 rounded-r-lg">
            Yearly <span className="text-green-500 font-semibold">20% Off</span>
          </button>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6 w-full max-w-6xl">
        ...
        <div className="relative bg-gradient-to-b from-green-900 to-black  rounded-xl p-6 flex flex-col items-center text-center">
<span
  className="absolute top-14 left-0 bg-blue-500 text-white text-[10px] px-2 py-1 font-semibold"
  style={{
    transform: 'rotate(-45deg)',
    transformOrigin: 'mt-10 left',
    width: '100px',
    textAlign: 'center',
  }}
>
  Most Popular
          ...
          <button className="bg-white text-[rgba(2,85,229,1)]   h-[48px] w-[228px] px-4 py-2 mt-28 rounded-md font-semibold">
            Upgrade Now
          </button>
        </div>
